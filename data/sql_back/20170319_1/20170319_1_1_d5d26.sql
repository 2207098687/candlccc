...
DROP TABLE IF EXISTS `club_activity_detail`;
CREATE TABLE `club_activity_detail` (
...
DROP TABLE IF EXISTS `club_address`;
CREATE TABLE `club_address` (
...
DROP TABLE IF EXISTS `club_admin_log`;
CREATE TABLE `club_admin_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=67 DEFAULT CHARSET=utf8 COMMENT='管理员操作日志';

DROP TABLE IF EXISTS `club_adv`;
CREATE TABLE `club_adv` (
...
DROP TABLE IF EXISTS `club_adv_position`;
CREATE TABLE `club_adv_position` (
...
DROP TABLE IF EXISTS `club_album_class`;
CREATE TABLE `club_album_class` (
...
DROP TABLE IF EXISTS `club_album_pic`;
CREATE TABLE `club_album_pic` (
...
DROP TABLE IF EXISTS `club_apiseccode`;
CREATE TABLE `club_apiseccode` (
...
DROP TABLE IF EXISTS `club_arrival_notice`;
CREATE TABLE `club_arrival_notice` (
...
DROP TABLE IF EXISTS `club_article_class`;
CREATE TABLE `club_article_class` (
...
DROP TABLE IF EXISTS `club_attribute`;
CREATE TABLE `club_attribute` (
...
DROP TABLE IF EXISTS `club_attribute_value`;
CREATE TABLE `club_attribute_value` (
...
DROP TABLE IF EXISTS `club_bill_create`;
CREATE TABLE `club_bill_create` (
...
DROP TABLE IF EXISTS `club_brand`;
CREATE TABLE `club_brand` (
...
DROP TABLE IF EXISTS `club_cart`;
CREATE TABLE `club_cart` (
...
DROP TABLE IF EXISTS `club_chain`;
CREATE TABLE `club_chain` (
...
DROP TABLE IF EXISTS `club_chain_stock`;
CREATE TABLE `club_chain_stock` (
...
DROP TABLE IF EXISTS `club_chat_log`;
...
DROP TABLE IF EXISTS `club_chat_msg`;
CREATE TABLE `club_chat_msg` (
  `m_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '记录ID',
  `f_id` int(10) unsigned NOT NULL COMMENT '会员ID',
  `f_name` varchar(50) NOT NULL COMMENT '会员名',
  `f_ip` varchar(15) NOT NULL COMMENT '发自IP',
...
DROP TABLE IF EXISTS `club_circle`;
CREATE TABLE `club_circle` (
...
DROP TABLE IF EXISTS `club_circle_affix`;
CREATE TABLE `club_circle_affix` (
...
DROP TABLE IF EXISTS `club_circle_class`;
CREATE TABLE `club_circle_class` (
...
DROP TABLE IF EXISTS `club_circle_explog`;
CREATE TABLE `club_circle_explog` (
...
DROP TABLE IF EXISTS `club_circle_expmember`;
CREATE TABLE `club_circle_expmember` (
...
DROP TABLE IF EXISTS `club_circle_exptheme`;
CREATE TABLE `club_circle_exptheme` (
  `theme_id` int(11) unsigned NOT NULL COMMENT '主题id',
...
DROP TABLE IF EXISTS `club_circle_fs`;
CREATE TABLE `club_circle_fs` (
  `circle_id` int(11) unsigned NOT NULL COMMENT '圈子id',
...
DROP TABLE IF EXISTS `club_circle_inform`;
CREATE TABLE `club_circle_inform` (
...
DROP TABLE IF EXISTS `club_circle_like`;
CREATE TABLE `club_circle_like` (
  `theme_id` int(11) unsigned NOT NULL COMMENT '主题id',
  `member_id` int(11) unsigned NOT NULL COMMENT '会员id',
  `circle_id` int(11) unsigned NOT NULL COMMENT '圈子id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='主题赞表';

DROP TABLE IF EXISTS `club_circle_mapply`;
CREATE TABLE `club_circle_mapply` (
...
DROP TABLE IF EXISTS `club_circle_member`;
CREATE TABLE `club_circle_member` (
  `member_id` int(11) unsigned NOT NULL COMMENT '会员id',
  `circle_id` int(11) unsigned NOT NULL COMMENT '圈子id',
...
DROP TABLE IF EXISTS `club_circle_ml`;
CREATE TABLE `club_circle_ml` (
  `circle_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '圈子id',
...
DROP TABLE IF EXISTS `club_circle_mldefault`;
CREATE TABLE `club_circle_mldefault` (
...
DROP TABLE IF EXISTS `club_circle_mlref`;
CREATE TABLE `club_circle_mlref` (
...
DROP TABLE IF EXISTS `club_circle_recycle`;
CREATE TABLE `club_circle_recycle` (
...
DROP TABLE IF EXISTS `club_circle_thclass`;
CREATE TABLE `club_circle_thclass` (
...
DROP TABLE IF EXISTS `club_circle_theme`;
CREATE TABLE `club_circle_theme` (
...
DROP TABLE IF EXISTS `club_circle_thg`;
CREATE TABLE `club_circle_thg` (
...
DROP TABLE IF EXISTS `club_circle_thpoll`;
CREATE TABLE `club_circle_thpoll` (
  `theme_id` int(11) unsigned NOT NULL COMMENT '话题id',
...
DROP TABLE IF EXISTS `club_circle_thpolloption`;
CREATE TABLE `club_circle_thpolloption` (
...
DROP TABLE IF EXISTS `club_circle_thpollvoter`;
CREATE TABLE `club_circle_thpollvoter` (
  `theme_id` int(11) unsigned NOT NULL COMMENT '话题id',
  `member_id` int(11) unsigned NOT NULL COMMENT '成员id',
  `member_name` varchar(50) NOT NULL COMMENT '成员名称',
...
DROP TABLE IF EXISTS `club_circle_threply`;
CREATE TABLE `club_circle_threply` (
  `theme_id` int(11) unsigned NOT NULL COMMENT '主题id',
...
DROP TABLE IF EXISTS `club_cms_article`;
CREATE TABLE `club_cms_article` (
...
DROP TABLE IF EXISTS `club_cms_article_attitude`;
CREATE TABLE `club_cms_article_attitude` (
...
DROP TABLE IF EXISTS `club_cms_article_class`;
CREATE TABLE `club_cms_article_class` (
...
DROP TABLE IF EXISTS `club_cms_comment`;
CREATE TABLE `club_cms_comment` (
...
DROP TABLE IF EXISTS `club_cms_comment_up`;
CREATE TABLE `club_cms_comment_up` (
...
DROP TABLE IF EXISTS `club_cms_index_module`;
CREATE TABLE `club_cms_index_module` (
...
DROP TABLE IF EXISTS `club_cms_module`;
CREATE TABLE `club_cms_module` (
...
DROP TABLE IF EXISTS `club_cms_module_assembly`;
CREATE TABLE `club_cms_module_assembly` (
...
DROP TABLE IF EXISTS `club_cms_module_frame`;
CREATE TABLE `club_cms_module_frame` (
...
DROP TABLE IF EXISTS `club_cms_navigation`;
CREATE TABLE `club_cms_navigation` (
...
DROP TABLE IF EXISTS `club_cms_picture`;
CREATE TABLE `club_cms_picture` (
...
DROP TABLE IF EXISTS `club_cms_picture_class`;
CREATE TABLE `club_cms_picture_class` (
  `class_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '分类编号 ',
  `class_name` varchar(50) NOT NULL COMMENT '分类名称',
  `class_sort` tinyint(1) unsigned NOT NULL DEFAULT '255' COMMENT '排序',
  PRIMARY KEY (`class_id`)
...
DROP TABLE IF EXISTS `club_cms_picture_image`;
CREATE TABLE `club_cms_picture_image` (
...
DROP TABLE IF EXISTS `club_cms_special`;
CREATE TABLE `club_cms_special` (
...
DROP TABLE IF EXISTS `club_cms_tag`;
CREATE TABLE `club_cms_tag` (
...
DROP TABLE IF EXISTS `club_cms_tag_relation`;
CREATE TABLE `club_cms_tag_relation` (
...
DROP TABLE IF EXISTS `club_complain`;
CREATE TABLE `club_complain` (
...
DROP TABLE IF EXISTS `club_complain_subject`;
CREATE TABLE `club_complain_subject` (
...
DROP TABLE IF EXISTS `club_complain_talk`;
CREATE TABLE `club_complain_talk` (
...
DROP TABLE IF EXISTS `club_consult`;
CREATE TABLE `club_consult` (
...
DROP TABLE IF EXISTS `club_consult_type`;
CREATE TABLE `club_consult_type` (
...
DROP TABLE IF EXISTS `club_consume`;
CREATE TABLE `club_consume` (
...
DROP TABLE IF EXISTS `club_contract`;
CREATE TABLE `club_contract` (
...
DROP TABLE IF EXISTS `club_contract_apply`;
CREATE TABLE `club_contract_apply` (
...
DROP TABLE IF EXISTS `club_contract_costlog`;
CREATE TABLE `club_contract_costlog` (
...
DROP TABLE IF EXISTS `club_contract_item`;
CREATE TABLE `club_contract_item` (
...
DROP TABLE IF EXISTS `club_contract_log`;
CREATE TABLE `club_contract_log` (
...
DROP TABLE IF EXISTS `club_contract_quitapply`;
CREATE TABLE `club_contract_quitapply` (
...
DROP TABLE IF EXISTS `club_cron`;
CREATE TABLE `club_cron` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `club_daddress`;
CREATE TABLE `club_daddress` (
  `address_id` mediumint(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '地址ID',
...
DROP TABLE IF EXISTS `club_delivery_order`;
CREATE TABLE `club_delivery_order` (
  `order_id` int(11) NOT NULL COMMENT '订单ID',
...
DROP TABLE IF EXISTS `club_delivery_point`;
CREATE TABLE `club_delivery_point` (
...
DROP TABLE IF EXISTS `club_document`;
CREATE TABLE `club_document` (
...
DROP TABLE IF EXISTS `club_evaluate_goods`;
CREATE TABLE `club_evaluate_goods` (
...
DROP TABLE IF EXISTS `club_evaluate_store`;
CREATE TABLE `club_evaluate_store` (
...
DROP TABLE IF EXISTS `club_exppoints_log`;
CREATE TABLE `club_exppoints_log` (
...
DROP TABLE IF EXISTS `club_express`;
CREATE TABLE `club_express` (
...
DROP TABLE IF EXISTS `club_flowstat`;
CREATE TABLE `club_flowstat` (
...
DROP TABLE IF EXISTS `club_flowstat_1`;
CREATE TABLE `club_flowstat_1` (
  `stattime` int(11) unsigned NOT NULL COMMENT '访问日期',
  `clicknum` int(11) unsigned NOT NULL COMMENT '访问量',
  `store_id` int(11) unsigned NOT NULL COMMENT '店铺ID',
  `type` varchar(10) NOT NULL COMMENT '类型',
...
DROP TABLE IF EXISTS `club_flowstat_2`;
CREATE TABLE `club_flowstat_2` (
  `stattime` int(11) unsigned NOT NULL COMMENT '访问日期',
  `clicknum` int(11) unsigned NOT NULL COMMENT '访问量',
  `store_id` int(11) unsigned NOT NULL COMMENT '店铺ID',
  `type` varchar(10) NOT NULL COMMENT '类型',
...
DROP TABLE IF EXISTS `club_gadmin`;
CREATE TABLE `club_gadmin` (
...
DROP TABLE IF EXISTS `club_goods`;
CREATE TABLE `club_goods` (
...
) ENGINE=InnoDB AUTO_INCREMENT=100010 DEFAULT CHARSET=utf8 COMMENT='商品表';

DROP TABLE IF EXISTS `club_goods_attr_index`;
CREATE TABLE `club_goods_attr_index` (
  `goods_id` int(10) unsigned NOT NULL COMMENT '商品id',
  `goods_commonid` int(10) unsigned NOT NULL COMMENT '商品公共表id',
  `gc_id` int(10) unsigned NOT NULL COMMENT '商品分类id',
  `type_id` int(10) unsigned NOT NULL COMMENT '类型id',
...
DROP TABLE IF EXISTS `club_goods_browse`;
CREATE TABLE `club_goods_browse` (
  `goods_id` int(11) NOT NULL COMMENT '商品ID',
  `member_id` int(11) NOT NULL COMMENT '会员ID',
...
DROP TABLE IF EXISTS `club_goods_class`;
CREATE TABLE `club_goods_class` (
...
DROP TABLE IF EXISTS `club_goods_class_nav`;
CREATE TABLE `club_goods_class_nav` (
...
DROP TABLE IF EXISTS `club_goods_class_staple`;
CREATE TABLE `club_goods_class_staple` (
...
DROP TABLE IF EXISTS `club_goods_class_tag`;
CREATE TABLE `club_goods_class_tag` (
...
DROP TABLE IF EXISTS `club_goods_common`;
CREATE TABLE `club_goods_common` (
...
) ENGINE=InnoDB AUTO_INCREMENT=100010 DEFAULT CHARSET=utf8 COMMENT='商品公共内容表';

DROP TABLE IF EXISTS `club_goods_fcode`;
CREATE TABLE `club_goods_fcode` (
...
DROP TABLE IF EXISTS `club_goods_gift`;
CREATE TABLE `club_goods_gift` (
...
DROP TABLE IF EXISTS `club_goods_images`;
CREATE TABLE `club_goods_images` (
...
DROP TABLE IF EXISTS `club_goods_recommend`;
CREATE TABLE `club_goods_recommend` (
...
DROP TABLE IF EXISTS `club_groupbuy`;
CREATE TABLE `club_groupbuy` (
...
DROP TABLE IF EXISTS `club_groupbuy_class`;
CREATE TABLE `club_groupbuy_class` (
...
DROP TABLE IF EXISTS `club_groupbuy_price_range`;
CREATE TABLE `club_groupbuy_price_range` (
...
DROP TABLE IF EXISTS `club_groupbuy_quota`;
CREATE TABLE `club_groupbuy_quota` (
...
DROP TABLE IF EXISTS `club_help_type`;
CREATE TABLE `club_help_type` (
...
DROP TABLE IF EXISTS `club_inform`;
CREATE TABLE `club_inform` (
...
DROP TABLE IF EXISTS `club_inform_subject`;
CREATE TABLE `club_inform_subject` (
...
DROP TABLE IF EXISTS `club_inform_subject_type`;
CREATE TABLE `club_inform_subject_type` (
...
DROP TABLE IF EXISTS `club_invoice`;
CREATE TABLE `club_invoice` (
...
DROP TABLE IF EXISTS `club_link`;
CREATE TABLE `club_link` (
  ...
  PRIMARY KEY (`link_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='合作伙伴表';

DROP TABLE IF EXISTS `club_lock`;
CREATE TABLE `club_lock` (
...
DROP TABLE IF EXISTS `club_mail_cron`;
CREATE TABLE `club_mail_cron` (
...
DROP TABLE IF EXISTS `club_mail_msg_temlates`;
CREATE TABLE `club_mail_msg_temlates` (
...
DROP TABLE IF EXISTS `club_mall_consult`;
CREATE TABLE `club_mall_consult` (
...
DROP TABLE IF EXISTS `club_mall_consult_type`;
CREATE TABLE `club_mall_consult_type` (
...
DROP TABLE IF EXISTS `club_mb_category`;
CREATE TABLE `club_mb_category` (
...
DROP TABLE IF EXISTS `club_mb_feedback`;
CREATE TABLE `club_mb_feedback` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `club_mb_payment`;
CREATE TABLE `club_mb_payment` (
...
DROP TABLE IF EXISTS `club_mb_seller_token`;
CREATE TABLE `club_mb_seller_token` (
...
DROP TABLE IF EXISTS `club_mb_special`;
CREATE TABLE `club_mb_special` (
  `special_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '专题编号',
  `special_desc` varchar(20) NOT NULL COMMENT '专题描述',
  PRIMARY KEY (`special_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='手机专题表';

DROP TABLE IF EXISTS `club_mb_special_item`;
CREATE TABLE `club_mb_special_item` (
...
DROP TABLE IF EXISTS `club_mb_user_token`;
CREATE TABLE `club_mb_user_token` (
  `token_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '令牌编号',
  `member_id` int(10) unsigned NOT NULL COMMENT '用户编号',
  `member_name` varchar(50) NOT NULL COMMENT '用户名',
  `token` varchar(50) NOT NULL COMMENT '登录令牌',
...
DROP TABLE IF EXISTS `club_member_common`;
CREATE TABLE `club_member_common` (
  `member_id` int(11) NOT NULL COMMENT '会员ID',
...
DROP TABLE IF EXISTS `club_member_msg_setting`;
CREATE TABLE `club_member_msg_setting` (
...
DROP TABLE IF EXISTS `club_member_msg_tpl`;
CREATE TABLE `club_member_msg_tpl` (
  `mmt_code` varchar(50) NOT NULL COMMENT '用户消息模板编号',
...
DROP TABLE IF EXISTS `club_micro_adv`;
CREATE TABLE `club_micro_adv` (
...
DROP TABLE IF EXISTS `club_micro_comment`;
CREATE TABLE `club_micro_comment` (
  `comment_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '评论编号',
  `comment_type` tinyint(1) NOT NULL COMMENT '评论类型编号',
  `comment_object_id` int(10) unsigned NOT NULL COMMENT '推荐商品编号',
...
DROP TABLE IF EXISTS `club_micro_goods`;
CREATE TABLE `club_micro_goods` (
...
DROP TABLE IF EXISTS `club_micro_goods_class`;
CREATE TABLE `club_micro_goods_class` (
...
DROP TABLE IF EXISTS `club_micro_goods_relation`;
CREATE TABLE `club_micro_goods_relation` (
  `relation_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '关系编号',
...
DROP TABLE IF EXISTS `club_micro_like`;
CREATE TABLE `club_micro_like` (
...
DROP TABLE IF EXISTS `club_micro_member_info`;
CREATE TABLE `club_micro_member_info` (
...
DROP TABLE IF EXISTS `club_micro_personal`;
CREATE TABLE `club_micro_personal` (
...
DROP TABLE IF EXISTS `club_micro_personal_class`;
CREATE TABLE `club_micro_personal_class` (
  `class_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '分类编号 ',
  `class_name` varchar(50) NOT NULL COMMENT '分类名称',
  `class_sort` tinyint(4) unsigned NOT NULL COMMENT '排序',
  `class_image` varchar(100) DEFAULT '' COMMENT '分类图片',
...
DROP TABLE IF EXISTS `club_micro_store`;
CREATE TABLE `club_micro_store` (
...
DROP TABLE IF EXISTS `club_navigation`;
CREATE TABLE `club_navigation` (
...
DROP TABLE IF EXISTS `club_offpay_area`;
CREATE TABLE `club_offpay_area` (
...
DROP TABLE IF EXISTS `club_order_bill`;
CREATE TABLE `club_order_bill` (
...
DROP TABLE IF EXISTS `club_order_book`;
CREATE TABLE `club_order_book` (
...
DROP TABLE IF EXISTS `club_order_common`;
CREATE TABLE `club_order_common` (
...
DROP TABLE IF EXISTS `club_order_goods`;
CREATE TABLE `club_order_goods` (
...
DROP TABLE IF EXISTS `club_order_log`;
...
DROP TABLE IF EXISTS `club_order_pay`;
CREATE TABLE `club_order_pay` (
...
DROP TABLE IF EXISTS `club_order_snapshot`;
CREATE TABLE `club_order_snapshot` (
...
DROP TABLE IF EXISTS `club_order_statis`;
CREATE TABLE `club_order_statis` (
...
DROP TABLE IF EXISTS `club_p_book_quota`;
CREATE TABLE `club_p_book_quota` (
...
DROP TABLE IF EXISTS `club_p_booth_goods`;
CREATE TABLE `club_p_booth_goods` (
...
DROP TABLE IF EXISTS `club_p_booth_quota`;
CREATE TABLE `club_p_booth_quota` (
...
DROP TABLE IF EXISTS `club_p_bundling`;
CREATE TABLE `club_p_bundling` (
...
DROP TABLE IF EXISTS `club_p_bundling_goods`;
CREATE TABLE `club_p_bundling_goods` (
...
DROP TABLE IF EXISTS `club_p_bundling_quota`;
CREATE TABLE `club_p_bundling_quota` (
...
DROP TABLE IF EXISTS `club_p_combo_goods`;
CREATE TABLE `club_p_combo_goods` (
...
DROP TABLE IF EXISTS `club_p_combo_quota`;
CREATE TABLE `club_p_combo_quota` (
...
DROP TABLE IF EXISTS `club_p_cou`;
CREATE TABLE `club_p_cou` (
...
DROP TABLE IF EXISTS `club_p_cou_level`;
CREATE TABLE `club_p_cou_level` (
...
DROP TABLE IF EXISTS `club_p_cou_level_sku`;
CREATE TABLE `club_p_cou_level_sku` (
  `cou_id` int(11) NOT NULL COMMENT '加价购ID',
  `xlevel` tinyint(3) unsigned NOT NULL COMMENT '等级',
...
DROP TABLE IF EXISTS `club_p_cou_quota`;
CREATE TABLE `club_p_cou_quota` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `store_id` int(11) NOT NULL COMMENT '店铺ID',
  `store_name` varchar(50) NOT NULL COMMENT '店铺名称',
  `tstart` int(10) unsigned NOT NULL COMMENT '开始时间',
...
DROP TABLE IF EXISTS `club_p_cou_sku`;
CREATE TABLE `club_p_cou_sku` (
  `sku_id` int(11) NOT NULL COMMENT '商品条目ID',
  `cou_id` int(11) NOT NULL COMMENT '加价购ID',
  `tstart` int(10) unsigned NOT NULL COMMENT '开始时间',
  `tend` int(10) unsigned NOT NULL COMMENT '结束时间',
...
DROP TABLE IF EXISTS `club_p_fcode_quota`;
CREATE TABLE `club_p_fcode_quota` (
...
DROP TABLE IF EXISTS `club_p_mansong`;
CREATE TABLE `club_p_mansong` (
...
DROP TABLE IF EXISTS `club_p_mansong_quota`;
CREATE TABLE `club_p_mansong_quota` (
...
DROP TABLE IF EXISTS `club_p_mansong_rule`;
CREATE TABLE `club_p_mansong_rule` (
...
DROP TABLE IF EXISTS `club_p_sole_goods`;
CREATE TABLE `club_p_sole_goods` (
...
DROP TABLE IF EXISTS `club_p_sole_quota`;
CREATE TABLE `club_p_sole_quota` (
...
DROP TABLE IF EXISTS `club_p_xianshi`;
CREATE TABLE `club_p_xianshi` (
...
DROP TABLE IF EXISTS `club_p_xianshi_goods`;
CREATE TABLE `club_p_xianshi_goods` (
...
DROP TABLE IF EXISTS `club_p_xianshi_quota`;
CREATE TABLE `club_p_xianshi_quota` (
...
DROP TABLE IF EXISTS `club_pd_cash`;
CREATE TABLE `club_pd_cash` (
...
DROP TABLE IF EXISTS `club_pd_log`;
CREATE TABLE `club_pd_log` (
...
DROP TABLE IF EXISTS `club_pd_recharge`;
CREATE TABLE `club_pd_recharge` (
...
DROP TABLE IF EXISTS `club_points_cart`;
CREATE TABLE `club_points_cart` (
...
DROP TABLE IF EXISTS `club_points_goods`;
CREATE TABLE `club_points_goods` (
...
DROP TABLE IF EXISTS `club_points_log`;
CREATE TABLE `club_points_log` (
...
DROP TABLE IF EXISTS `club_points_order`;
CREATE TABLE `club_points_order` (
...
DROP TABLE IF EXISTS `club_points_orderaddress`;
CREATE TABLE `club_points_orderaddress` (
...
DROP TABLE IF EXISTS `club_points_ordergoods`;
CREATE TABLE `club_points_ordergoods` (
...
DROP TABLE IF EXISTS `club_rcb_log`;
CREATE TABLE `club_rcb_log` (
...
DROP TABLE IF EXISTS `club_rec_position`;
CREATE TABLE `club_rec_position` (
...
DROP TABLE IF EXISTS `club_rechargecard`;
CREATE TABLE `club_rechargecard` (
...
DROP TABLE IF EXISTS `club_redpacket`;
CREATE TABLE `club_redpacket` (
...
DROP TABLE IF EXISTS `club_redpacket_template`;
CREATE TABLE `club_redpacket_template` (
...
DROP TABLE IF EXISTS `club_refund_detail`;
CREATE TABLE `club_refund_detail` (
...
DROP TABLE IF EXISTS `club_refund_reason`;
CREATE TABLE `club_refund_reason` (
...
DROP TABLE IF EXISTS `club_refund_return`;
CREATE TABLE `club_refund_return` (
...
DROP TABLE IF EXISTS `club_seller`;
CREATE TABLE `club_seller` (
...
DROP TABLE IF EXISTS `club_seller_group`;
CREATE TABLE `club_seller_group` (
...
DROP TABLE IF EXISTS `club_seller_group_bclass`;
CREATE TABLE `club_seller_group_bclass` (
...
DROP TABLE IF EXISTS `club_seller_log`;
CREATE TABLE `club_seller_log` (
...
DROP TABLE IF EXISTS `club_seo`;
CREATE TABLE `club_seo` (
...
DROP TABLE IF EXISTS `club_signin`;
CREATE TABLE `club_signin` (
...
DROP TABLE IF EXISTS `club_sms_log`;
CREATE TABLE `club_sms_log` (
  `log_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '记录ID',
...
DROP TABLE IF EXISTS `club_sns_albumclass`;
CREATE TABLE `club_sns_albumclass` (
...
DROP TABLE IF EXISTS `club_sns_albumpic`;
CREATE TABLE `club_sns_albumpic` (
...
DROP TABLE IF EXISTS `club_sns_binding`;
CREATE TABLE `club_sns_binding` (
...
DROP TABLE IF EXISTS `club_sns_comment`;
CREATE TABLE `club_sns_comment` (
...
DROP TABLE IF EXISTS `club_sns_friend`;
CREATE TABLE `club_sns_friend` (
...
DROP TABLE IF EXISTS `club_sns_goods`;
CREATE TABLE `club_sns_goods` (
...
DROP TABLE IF EXISTS `club_sns_membertag`;
CREATE TABLE `club_sns_membertag` (
...
DROP TABLE IF EXISTS `club_sns_mtagmember`;
CREATE TABLE `club_sns_mtagmember` (
...
DROP TABLE IF EXISTS `club_sns_setting`;
CREATE TABLE `club_sns_setting` (
  `member_id` int(11) NOT NULL COMMENT '会员id',
  `setting_skin` varchar(50) DEFAULT NULL COMMENT '皮肤',
  PRIMARY KEY (`member_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='个人中心设置表';

DROP TABLE IF EXISTS `club_sns_sharegoods`;
CREATE TABLE `club_sns_sharegoods` (
...
DROP TABLE IF EXISTS `club_sns_sharestore`;
CREATE TABLE `club_sns_sharestore` (
  `share_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
...
DROP TABLE IF EXISTS `club_sns_tracelog`;
CREATE TABLE `club_sns_tracelog` (
...
DROP TABLE IF EXISTS `club_sns_visitor`;
CREATE TABLE `club_sns_visitor` (
...
DROP TABLE IF EXISTS `club_spec`;
CREATE TABLE `club_spec` (
...
DROP TABLE IF EXISTS `club_spec_value`;
CREATE TABLE `club_spec_value` (
...
DROP TABLE IF EXISTS `club_stat_member`;
CREATE TABLE `club_stat_member` (
...
DROP TABLE IF EXISTS `club_stat_order`;
CREATE TABLE `club_stat_order` (
  `order_id` int(11) NOT NULL COMMENT '订单id',
  `order_sn` bigint(20) unsigned NOT NULL COMMENT '订单编号',
...
DROP TABLE IF EXISTS `club_stat_ordergoods`;
CREATE TABLE `club_stat_ordergoods` (
...
DROP TABLE IF EXISTS `club_store_bind_class`;
CREATE TABLE `club_store_bind_class` (
  `bid` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `club_store_class`;
CREATE TABLE `club_store_class` (
...
DROP TABLE IF EXISTS `club_store_cost`;
CREATE TABLE `club_store_cost` (
...
DROP TABLE IF EXISTS `club_store_decoration`;
CREATE TABLE `club_store_decoration` (
...
DROP TABLE IF EXISTS `club_store_decoration_album`;
CREATE TABLE `club_store_decoration_album` (
  `image_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '图片编号',
...
DROP TABLE IF EXISTS `club_store_decoration_block`;
CREATE TABLE `club_store_decoration_block` (
...
DROP TABLE IF EXISTS `club_store_distribution`;
CREATE TABLE `club_store_distribution` (
...
DROP TABLE IF EXISTS `club_store_extend`;
CREATE TABLE `club_store_extend` (
...
DROP TABLE IF EXISTS `club_store_goods_class`;
CREATE TABLE `club_store_goods_class` (
...
DROP TABLE IF EXISTS `club_store_grade`;
CREATE TABLE `club_store_grade` (
...
DROP TABLE IF EXISTS `club_store_joinin`;
CREATE TABLE `club_store_joinin` (
  `member_id` int(10) unsigned NOT NULL COMMENT '用户编号',
...
DROP TABLE IF EXISTS `club_store_map`;
CREATE TABLE `club_store_map` (
...
DROP TABLE IF EXISTS `club_store_msg`;
CREATE TABLE `club_store_msg` (
...
DROP TABLE IF EXISTS `club_store_msg_read`;
CREATE TABLE `club_store_msg_read` (
...
DROP TABLE IF EXISTS `club_store_msg_setting`;
CREATE TABLE `club_store_msg_setting` (
  `smt_code` varchar(100) NOT NULL COMMENT '模板编码',
  `store_id` int(10) unsigned NOT NULL COMMENT '店铺id',
...
DROP TABLE IF EXISTS `club_store_msg_tpl`;
CREATE TABLE `club_store_msg_tpl` (
  `smt_code` varchar(100) NOT NULL COMMENT '模板编码',
...
DROP TABLE IF EXISTS `club_store_navigation`;
CREATE TABLE `club_store_navigation` (
...
DROP TABLE IF EXISTS `club_store_plate`;
CREATE TABLE `club_store_plate` (
...
DROP TABLE IF EXISTS `club_store_reopen`;
CREATE TABLE `club_store_reopen` (
...
DROP TABLE IF EXISTS `club_store_sns_comment`;
CREATE TABLE `club_store_sns_comment` (
...
DROP TABLE IF EXISTS `club_store_sns_setting`;
CREATE TABLE `club_store_sns_setting` (
...
DROP TABLE IF EXISTS `club_store_sns_tracelog`;
CREATE TABLE `club_store_sns_tracelog` (
...
DROP TABLE IF EXISTS `club_store_supplier`;
CREATE TABLE `club_store_supplier` (
...
DROP TABLE IF EXISTS `club_store_watermark`;
CREATE TABLE `club_store_watermark` (
...
DROP TABLE IF EXISTS `club_store_waybill`;
CREATE TABLE `club_store_waybill` (
...
DROP TABLE IF EXISTS `club_transport`;
CREATE TABLE `club_transport` (
...
DROP TABLE IF EXISTS `club_transport_extend`;
CREATE TABLE `club_transport_extend` (
...
DROP TABLE IF EXISTS `club_type_brand`;
CREATE TABLE `club_type_brand` (
  `type_id` int(10) unsigned NOT NULL COMMENT '类型id',
  `brand_id` int(10) unsigned NOT NULL COMMENT '品牌id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='商品类型与品牌对应表';

DROP TABLE IF EXISTS `club_type_custom`;
CREATE TABLE `club_type_custom` (
...
DROP TABLE IF EXISTS `club_type_spec`;
CREATE TABLE `club_type_spec` (
  `type_id` int(10) unsigned NOT NULL COMMENT '类型id',
  `sp_id` int(10) unsigned NOT NULL COMMENT '规格id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='商品类型与规格对应表';

DROP TABLE IF EXISTS `club_upload`;
CREATE TABLE `club_upload` (
...
DROP TABLE IF EXISTS `club_voucher_price`;
CREATE TABLE `club_voucher_price` (
...
DROP TABLE IF EXISTS `club_voucher_quota`;
CREATE TABLE `club_voucher_quota` (
...
DROP TABLE IF EXISTS `club_voucher_template`;
CREATE TABLE `club_voucher_template` (
...
DROP TABLE IF EXISTS `club_vr_groupbuy_area`;
CREATE TABLE `club_vr_groupbuy_area` (
...
DROP TABLE IF EXISTS `club_vr_groupbuy_class`;
CREATE TABLE `club_vr_groupbuy_class` (
...
DROP TABLE IF EXISTS `club_vr_order`;
CREATE TABLE `club_vr_order` (
...
DROP TABLE IF EXISTS `club_vr_order_bill`;
CREATE TABLE `club_vr_order_bill` (
...
DROP TABLE IF EXISTS `club_vr_order_code`;
CREATE TABLE `club_vr_order_code` (
...
DROP TABLE IF EXISTS `club_vr_order_snapshot`;
CREATE TABLE `club_vr_order_snapshot` (
...
DROP TABLE IF EXISTS `club_vr_order_statis`;
CREATE TABLE `club_vr_order_statis` (
  `os_month` mediumint(9) unsigned NOT NULL DEFAULT '0' COMMENT '统计编号(年月)',
  `os_year` smallint(6) DEFAULT '0' COMMENT '年',
  `os_start_date` int(11) NOT NULL COMMENT '开始日期',
  `os_end_date` int(11) NOT NULL COMMENT '结束日期',
...
DROP TABLE IF EXISTS `club_vr_refund`;
CREATE TABLE `club_vr_refund` (
  `refund_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '记录ID',
...
DROP TABLE IF EXISTS `club_vr_refund_detail`;
CREATE TABLE `club_vr_refund_detail` (
  `refund_id` int(10) unsigned NOT NULL COMMENT '记录ID',
  `order_id` int(10) unsigned NOT NULL COMMENT '订单ID',
  `batch_no` varchar(32) NOT NULL COMMENT '批次号',
  `refund_amount` decimal(10,2) DEFAULT '0.00' COMMENT '退款金额',
...
DROP TABLE IF EXISTS `club_waybill`;
CREATE TABLE `club_waybill` (
...
DROP TABLE IF EXISTS `club_web`;
CREATE TABLE `club_web` (
...
DROP TABLE IF EXISTS `club_web_channel`;
CREATE TABLE `club_web_channel` (
...
DROP TABLE IF EXISTS `club_web_code`;
CREATE TABLE `club_web_code` (
  ...
  PRIMARY KEY (`code_id`),
  KEY `web_id` (`web_id`)
) ENGINE=InnoDB AUTO_INCREMENT=161 DEFAULT CHARSET=utf8 COMMENT='模块内容表';
