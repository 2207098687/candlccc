...
<div id="faq">
  <div class="wrapper">
    ...
    <ul>
      ...
      <li class="box-qr">
        <dl>
          <dt>We're On<a title="follow us <?php echo $output['setting_config']['site_name']; ?>Facebook" class="weixin">
                        <span class="weixin-qr"></span>
                    </a>
                    <a title="Follow us<?php echo $output['setting_config']['site_name']; ?>Twitter" class="weibo">
