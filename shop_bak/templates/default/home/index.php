...
<!--        新闻下面的区块-->
      <div class="ntrance">
      <ul>
        <li><a rel="nofollow" href="<?php echo urlShop('invite', 'index');?>" target="_self"><i class="i_ico01"></i>Referral</a></li>
    <li><a rel="nofollow" href="<?php echo BASE_SITE_URL;?>/other/service/index.html" target="_blank"><i class="i_ico02"></i>Guarantee</a></li>
    <li><a rel="nofollow" href="<?php echo BASE_SITE_URL;?>/other/guide/index.html" target="_blank"><i class="i_ico03"></i>Clear Flow</a></li>
    <li><a rel="nofollow" href="<?php echo DELIVERY_SITE_URL;?>" target="_self"><i class="i_ico04"></i>Big Save</a></li>
      <li><a rel="nofollow" href="<?php echo urlShop('show_joinin', 'index');?>" target="_self"><i class="i_ico05"></i>Partnership</a></li>
      <li><a rel="nofollow" href="<?php echo urlShop('seller_login','show_login');?>" target="_self"><i class="i_ico06"></i>Cares</a></li>
          ...
          <ul>
            ...
            <li>
              <dl style=" background-image:url(<?php echo gthumb($val['groupbuy_image1'], 'small');?>)">
                ...
                <dd class="price"><span class="groupbuy-price"><?php echo ncPriceFormatForList($val['groupbuy_price']); ?></span><span class="buy-button"><a href="<?php echo urlShop('show_groupbuy','groupbuy_detail',array('group_id'=> $val['groupbuy_id']));?>">Buy Now</a></span></dd>
                <dd class="time"><span class="sell">Sold<em><?php echo $val['buy_quantity']+$val['virtual_quantity'];?></em></span> <span class="time-remain" count_down="<?php echo $val['end_time']-TIMESTAMP; ?>"> <em time_id="d">0</em><?php echo $lang['text_tian'];?><em time_id="h">0</em><?php echo $lang['text_hour'];?> <em time_id="m">0</em><?php echo $lang['text_minute'];?><em time_id="s">0</em><?php echo $lang['text_second'];?> </span></dd>
              </dl>
            </li>
            <?php } ?>
          </ul>
