...
class BaseMemberControl extends Control {
    ...
    private function _getMenuList() {
        $menu_list = array(
            'info' => array('name' => 'Member Info', 'child' => array(
                'member_information'=> array('name' => 'Account Info', 'url'=>urlMember('member_information', 'member')),
...
//                'member_sharemanage'=> array('name' => 'Share Bind', 'url'=>urlMember('member_sharemanage', 'index'))
            ...
            'property' => array('name' => 'My Asset', 'child' => array(
                ...
                'member_redpacket'  => array('name' => 'My Voucher', 'url'=>urlMember('member_redpacket', 'index'))
