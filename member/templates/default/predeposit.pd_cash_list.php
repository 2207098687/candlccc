...
<!--    <a class="ncbtn ncbtn-mint" href="index.php?act=member_security&op=auth&type=pd_cash"><i class="icon-money"></i>Cash-out Request</a>-->
  </div>
    ...
    <table class="ncm-search-table">
      ...
      <th></th><td></td>
        ...
        <td class="w90"><select id="paystate_search" name="paystate_search">
            ...
            <option <?php if ($_GET['paystate_search'] == '0') echo 'selected';?> value="0">Unpaid</option>
            <option <?php if ($_GET['paystate_search'] == '1') echo 'selected';?> value="1">Paid</option>
          </select>
       </td>
  ...
  <table class="ncm-default-table">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td><?php echo str_replace(array('0','1'),array('Unpaid','Paid'),$val['pdc_payment_state']);?></td>
