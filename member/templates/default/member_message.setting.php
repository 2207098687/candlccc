...
<!--    <a href="index.php?act=member_message&op=sendmsg" class="ncbtn ncbtn-bittersweet" title="--><?php //echo $lang['home_message_send_message'];?><!--"><i class="icon-envelope-alt"></i>--><?php //echo $lang['home_message_send_message'];?><!--</a>-->
  ...
  <div class="ncm-message-setting">
    <form method="post" action="<?php echo urlMember('member_message', 'setting');?>" id="setting_form" onsubmit="ajaxpost('setting_form', '', '', 'onerror');">
      ...
      <dl>
        <dt><span><i class="icon-shopping-cart"></i></span>Order</dt>
        <dd>
          <ul>
            <li>
              ...
              <label for="order_payment_success">Paied Order</label></li>
            <li>
              ...
              <label for="order_deliver_success">Dispatch</label></li>
<!--            <li>-->
...
<!--              <label for="vr_code_will_expire">Virtual Purchasing Code Expiry</label></li>-->
            <li>
              ...
              <label for="vr_code_will_expire">Pay Outstanding Balance</label></li>
          </ul>
        </dd>
      </dl>
      <dl>
        <dt><span><i class="icon-money"></i></span>Account</dt>
        <dd>
          <ul>
            <li>
              ...
              <label for="predeposit_change">Balance Change</label></li>
<!--            <li>-->
...
<!--              <label for="recharge_card_balance_change">充值卡余额变动提醒</label></li>-->
            <li>
              ...
              <label for="voucher_use">Use Coupon</label></li>
            <li>
              ...
              <label for="voucher_use">Use Voucher</label></li>
            <li>
              ...
              <label for="voucher_will_expire">Coupon Expiry</label></li>
          </ul>
        </dd>
      </dl>
      <dl>
        <dt><span><i class="icon-coffee"></i></span>Aftersales</dt>
        <dd>
          <ul>
            <li>
              ...
              <label for="refund_return_notice">Return/Refund</label></li>
            <li>
              ...
              <label for="arrival_notice">Arrival Stock</label></li>
            <li>
              ...
              <label for="consult_goods_reply">Product Inquiry</label></li>
            <li>
              ...
              <label for="consult_mall_reply">Other Inquiry</label></li>
          </ul>
        </dd>
      </dl>
      <div class="bottom tc">
        <label class="submit-border">
          <input id="btn_inform_submit" type="submit" class="submit" value="Save" />
        </label>
      </div>
    </form>
  </div>
