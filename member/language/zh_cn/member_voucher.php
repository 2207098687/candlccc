...
$lang['voucher_unavailable']    = 'Coupon Function Not Available';//'代金券功能尚未开启';
$lang['voucher_applystate_new']    = 'Pending Review';//待审核
$lang['voucher_applystate_verify']    = 'Reviewed';//已审核
$lang['voucher_applystate_cancel']    = 'Cancelled';//已取消
$lang['voucher_quotastate_activity']	= 'Normal';//正常
$lang['voucher_quotastate_cancel']    = 'Cancel';//取消
$lang['voucher_quotastate_expire']    = 'End';//结束
$lang['voucher_templatestate_usable']	= 'Valid';//有效
$lang['voucher_templatestate_disabled']= 'Invalid';//失效
$lang['voucher_quotalist']= 'Combo List';//套餐列表
$lang['voucher_applyquota']= 'Apply for Combo';//申请套餐
$lang['voucher_applyadd']= 'Buy Combo';//购买套餐
$lang['voucher_templateadd']= 'Add Coupon';//新增代金券
$lang['voucher_templateedit']= 'Edit Coupon';//编辑代金券
$lang['voucher_templateinfo']= 'Coupon Details';//代金券详细
/**
 * 套餐申请
 */
$lang['voucher_apply_num_error']= 'Quantity Should Not Be Empty, and Should Be Between 1-12 Digits';//数量不能为空，且必须为1-12之间的整数
 ...
 * 套餐
 */
$lang['voucher_quota_startdate']    	= 'Start Time';//开始时间
$lang['voucher_quota_enddate']    		= 'End Time';//结束时间
$lang['voucher_quota_timeslimit']    	= 'Times Limited';//活动次数限制
$lang['voucher_quota_publishedtimes']   = 'Released Times';//已发布活动次数
$lang['voucher_quota_residuetimes']    	= 'Remaining Times';//剩余活动次数
/**
 * 代金券模板
 */
